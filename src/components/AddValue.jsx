        ...
        <div className="flex items-center flex-col pt-10 pb-10 px-5">
            ...
            <form className="border rounded-lg shadow-lg bg-white p-6 flex flex-col w-full max-w-[768px] mt-8" onSubmit={submitHandler}>
                <div className="md:flex items-center justify-center md:justify-between gap-4">
                    <input required type="number" value={value1} onChange={(e) => setValue1(e.target.value)} className="flex-1 text-sm font-bold w-full outline-none border border-gray-300 rounded-lg p-4" placeholder="Enter first value" />
                    <p className="text-2xl font-bold text-gray-600 text-center">+</p>
                    <input required type="number" value={value2} onChange={(e) => setValue2(e.target.value)} className="flex-1 text-sm font-bold w-full outline-none border border-gray-300 rounded-lg p-4" placeholder="Enter second value" />
                </div>
